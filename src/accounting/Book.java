...
public class Book {
    ...
    private HashMap<Class<? extends contracts.Contract>,Account> defaultAssetAccounts;
    private HashMap<Class<? extends contracts.Contract>,Account> defaultLiabilityAccounts;
    ...
    private void addDefaultAssetAccount (Class<? extends contracts.Contract> contractSubclass, Account account) {
        //TODO handle repetitions
        defaultAssetAccounts.put(contractSubclass,account);
    }

    private void addDefaultLiabilityAccount (Class<? extends contracts.Contract> contractSubclass, Account account) {
        //TODO handle repetitions
...
//            owner.raiseLiquidity(amount - defaultCashAccount.getTotal());
